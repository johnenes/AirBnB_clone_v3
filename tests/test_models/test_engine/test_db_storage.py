...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        session = modes.storage._DBStorage__session
        retrieve_state = session.query(State).filter_by(id=new_state.id).first() #noqa
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_save(self):
        """Test that save properly saves iobjects to file.json"""
        state_data = {"name": "Nigeriss"}
        new_state = State(**state_data)
    ...
    def test_get(self):
        ...
        self.assertEqual(stat_instance, retrieve-state)
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_count(self):
        """ Testin method for obtaining instance db storage"""
        storage = models.storage

        storage.reload()

        state_data = {"name": "Kano"}
